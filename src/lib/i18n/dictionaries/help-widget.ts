...
const HELP_WIDGET_DICT: Record<Locale, HelpWidgetDict> = {
  ...
  hi: {
    ...
    defaultWelcome:
      "नमस्ते! मैं कॉन्टैक्ट्स, टेम्पलेट, ऑटोमेशन, SMS/WhatsApp सेटअप, भूमिकाओं और बिलिंग में मदद कर सकता हूँ। English, हिंदी, या मराठी में पूछें - मैं उसी भाषा में जवाब दूँगा।",
  ...
  mr: {
    ...
    defaultWelcome:
      "नमस्कार! मी कॉन्टॅक्ट्स, टेम्पलेट, ऑटोमेशन, SMS/WhatsApp सेटअप, भूमिका आणि बिलिंगमध्ये मदत करू शकतो. English, हिंदी, किंवा मराठीत विचारा - मी त्याच भाषेत उत्तर देईन.",
