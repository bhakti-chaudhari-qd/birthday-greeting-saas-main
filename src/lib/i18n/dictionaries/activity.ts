...
const ACTIVITY_DICT: Record<Locale, ActivityDict> = {
  ...
  hi: {
    header: {
      title: "एक्टिविटी",
      subtitle: "ग्रीटिंग डिलीवरी और संदेश इतिहास देखें।",
    ...
    emptyState: {
      ...
      description:
        "ऑटोमेशन से संदेश भेजना शुरू होते ही ग्रीटिंग डिलीवरी यहाँ दिखेंगी।",
    ...
    messages: {
      ...
      retryConfirmAmbiguous: (name) =>
        `${name} के लिए ग्रीटिंग फिर भेजें?\n\nअगर पहला संदेश पहले ही पहुँच चुका है, तो यह दूसरा संदेश भेज सकता है।`,
  ...
  mr: {
    header: {
      title: "अ‍ॅक्टिव्हिटी",
      subtitle: "ग्रीटिंग डिलिव्हरी आणि संदेश इतिहास पाहा.",
    ...
    emptyState: {
      ...
      description:
        "ऑटोमेशनने संदेश पाठवणे सुरू केल्यावर ग्रीटिंग डिलिव्हरी इथे दिसतील.",
    ...
    messages: {
      ...
      retryConfirmAmbiguous: (name) =>
        `${name} साठी ग्रीटिंग पुन्हा पाठवायची?\n\nपहिला संदेश आधीच पोहोचला असेल, तर हा दुसरा संदेश पाठवू शकतो.`,
